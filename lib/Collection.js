...
var Collection = function () {
  function Collection(_ref) {
    var Entry = _ref.Entry,
        ...
        options = _objectWithoutProperties(_ref, ['Entry', 'cockpit']);
  ...
  _createClass(Collection, [{
    ...
    value: function getFields() {
      return this.cockpit.collectionSchema(this.constructor.collectionName).then(function (_ref4) {
    ...
    value: function getEntries(fields, extraOptions) {
      return this.cockpit.collectionGet(this.constructor.collectionName, this.getOptions(Object.assign({}, extraOptions, { fields: fields }))).then(function (_ref5) {
    ...
    value: function fetch(fields, extraOptions) {
      return this.cockpit.collection(this.constructor.collectionName,
