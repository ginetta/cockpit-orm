...
var Entry = function () {
  ...
  _createClass(Entry, [{
    ...
    value: function getCollection() {
      ...
      return this.cockpit.collection(this.constructor.collectionName, { filter: filter });
    }
  }, {
    key: 'watch',
    ...
    key: 'save',
    value: function save() {
      return this.cockpit.collectionSave(this.constructor.collectionName, this.toObject());
    }
  }, {
    key: 'toObject',
