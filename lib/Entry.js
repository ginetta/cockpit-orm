...
var Entry = function () {
  ...
  _createClass(Entry, [{
    ...
    value: function sync() {
      ...
      var filter = Object.assign(_defineProperty({}, slugField, this.get(slugField)), options.filter || {});

      var collection = this.constructor.cockpit.collection(this.constructor.schema.name, Object.assign({}, options, { filter: filter }));
